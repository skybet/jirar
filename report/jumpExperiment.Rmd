...
```{r, echo=FALSE, warning=FALSE, error=FALSE}
recentTickets <- tsTickets %>% filter(resolutionDate > "2017-05-01") %>% select(-one_of("secondsInColumns.Open", "secondsInColumns.Reopened", "secondsInColumns.Resolved", "secondsInColumns.Closed"))
